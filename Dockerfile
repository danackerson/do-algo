...
ENTRYPOINT ansible-playbook --help && echo `curl -s https://slack.com/api/chat.postMessage -X POST -d "token=$slack_token&channel=#remote_network_report&text=algo&username=papa"`
