...
ENTRYPOINT ansible-playbook --help && curl https://slack.com/api/chat.postMessage -X POST -d 'token=${slack_token}&channel=#remote_network_report&text=algo&username=papa'
